...
def build_model(input_size, learning_rate, loss):
    """Build simple neural model for class prediction."""
    input_layer = tf.keras.layers.Input(input_size)
    reshape_layer = tf.keras.layers.Reshape((24, 76*2))(input_layer)
    hidden_layer_1 = tf.keras.layers.Dense(1024)(reshape_layer)
