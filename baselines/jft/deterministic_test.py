...
class DeterministicTest(parameterized.TestCase, tf.test.TestCase):
  ...
  @parameterized.parameters(
      ...
      ('imagenet2012', 'gap', None, 587.89453, 599.550985, 0.24, False),
      ('imagenet2012', 'gap', None, 587.89453, 599.550985, 0.24, True),
  )
  @flagsaver.flagsaver
  ...
  def test_loading_pretrained_model(self, dataset_name, classifier,
    ...
    pp_common += f'|onehot({config.num_classes}, key={label_key}, key_result="labels")'  # pylint: disable=line-too-long
